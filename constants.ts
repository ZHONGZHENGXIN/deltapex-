...
export const FAQS: FaqItem[] = [
  {
    question: "什么是 Futures Prop Firm 自营公司？",
    answer: "自营公司（Prop Firm）是指由公司提供资金给有技术的交易者进行操作，交易者无需承担本金风险。盈利后双方按比例分成（通常交易者拿80%-90%），仅需通过简单的模拟盘考核即可获得资金账号。"
  },
  {
    question: "为什么选择订单流（Order Flow）而不是传统技术指标？",
  ...
  },
  {
    ...
    answer: "“种田”是社区内部对利用自营公司低成本、高杠杆特性的规则化交易方案的爱称。通过建立多账号矩阵、严格执行高盈亏比订单流策略，实现像种田一样稳定、可持续的每日现金流出金。"
  },
  {
  ...
  },
  {
    ...
    answer: "建议加入我们的“系统交易课程”或关注 Bilibili 的交易日志。我们专注于 ATAS 订单流实战分析，通过每日复盘、盘前逻辑推导以及严格的风控心理建设，帮助学员从零建立正期望值的交易系统。"
  },
  {
    question: "支持哪些交易软件与数据接入？",
    answer: "目前主流自营平台（如 TPT、Lucid、TopOne 等）支持 Tradovate (TDV)、Rithmic 旗下所有软件。推荐使用 ATAS、Quantower 进行订单流微观盘口分析，或者使用 NinjaTrader 进行手动或自动化交易。"
  }
];
